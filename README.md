...
-> updated the delete enpoint code of userRoute, it will now delete all the subjects related to the particular use, instead of leaving all those tasks and notes permanently useless in dabtabase.